// These are element objects sort of (representation of HTML tags inside js file)
// If we console.log any of these the log would show, the Id specified html tag
...
let userData = {  // this obj will track user's data for playing deletion or keeping track of duration of songs.
    songs: [...allSongs],
    currentSong: null,
    songCurrentTime: 0,
};
